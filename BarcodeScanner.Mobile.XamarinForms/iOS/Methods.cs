...
namespace BarcodeScanner.Mobile
{
    public class Methods
    {
        ...
        {
            List<Xamarin.Forms.Point> cornerPoints = new List<Xamarin.Forms.Point>();

            foreach (var cornerPoint in barcode.CornerPoints)
                cornerPoints.Add(new Xamarin.Forms.Point(cornerPoint.CGPointValue.X, cornerPoint.CGPointValue.Y));
