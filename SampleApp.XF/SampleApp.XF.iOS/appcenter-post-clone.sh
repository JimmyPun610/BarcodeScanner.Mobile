...
ROOT_FOLDER=$APPCENTER_SOURCE_DIRECTORY/BarcodeScanner.Mobile
...
dotnet sln $ROOT_FOLDER/BarcodeScanner.Mobile.sln remove $ROOT_FOLDER/SampleApp.XF/SampleApp.XF.Android/SampleApp.XF.Android.cspro
