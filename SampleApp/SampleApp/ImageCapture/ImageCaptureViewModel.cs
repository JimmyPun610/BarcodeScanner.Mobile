...
namespace SampleApp.ImageCapture
{
    public class ImageCaptureViewModel : INotifyPropertyChanged
    {
        ...
        public ImageCaptureViewModel()
        {
            ...
            this.OnDetectCommand = new Command<GoogleVisionBarCodeScanner.OnDetectedEventArg>(ExecuteOnDetectedCommand);
            this.Result = string.Empty;
            this.showCamera = true;
            this.showImage = false;
        }

        public void ExecuteOnDetectedCommand(GoogleVisionBarCodeScanner.OnDetectedEventArg arg)
        {
            List<GoogleVisionBarCodeScanner.BarcodeResult> obj = arg.BarcodeResults;
